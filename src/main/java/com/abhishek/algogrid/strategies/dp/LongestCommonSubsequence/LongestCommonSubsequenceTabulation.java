...
public class LongestCommonSubsequenceTabulation implements AGProblemStrategy<LongestCommonSubsequenceInput, Integer> {
    @Override
    public Integer solve(LongestCommonSubsequenceInput input) {
        throw new UnsupportedOperationException("TODO: Implement LongestCommonSubsequence - Bottom-Up Tabulation");
    }
